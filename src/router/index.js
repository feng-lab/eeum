...
import LemurFullResolutionViewGuide from '@/components/core/LemurFullResolutionViewGuide';
...
export default new Router({
  ...
  routes: [
    ...
    {
      path: '/lemurfullresolutionviewguide',
      name: 'LemurFullResolutionViewGuide',
      component: LemurFullResolutionViewGuide,
    },
    {
      path: '/lemur3datlas',
      name: 'Lemur3DAtlas',

      ...
      items: [
        {
          ...
          empty: '',
          fullResolutionView:
            'neuroglancer/#!https://fenglab.xyz/static/neuroglancer_data/181005_Lemur-Hotsauce_SMI99_VGluT2_NeuN/base.json',
          channels: [
            {
              name: 'SMI99',
              color: '#00A0FF',
        ...
        },
        {
          ...
          numSlices: 180,
          sliceSrc:
            'https://fenglab.xyz/static/static/reference_gallery/ref2/slice',
          startSlice: 1,
          swiperOption: {
            lazy: true,
            direction: 'horizontal',
          ...
          empty: '',
          fullResolutionView:
            'neuroglancer/#!https://fenglab.xyz/static/neuroglancer_data/20190813_jellybean_FOXP2_SMI32_NeuN/base.json',
          channels: [
            {
              name: 'TH',
              color: '#00A0FF',

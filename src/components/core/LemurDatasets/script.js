    ...
    return {
      ...
      items: [
        ...
        },
        {
          ...
          numSlices: 168,
          sliceSrc:
            'https://eeum-brain.com/static/static/eLemur-A2/slice',
          startSlice: 1,
          swiperOption: {
            lazy: true,
            direction: 'horizontal',
          ...
          empty: '',
          fullResolutionView:
            'neuroglancer/#!https://eeum-brain.com/static/neuroglancer_data/20190813_jellybean_FOXP2_SMI32_NeuN/base.json',
          channels: [
            {
              name: 'PV',
              color: '#00A0FF',
        ...
        },
        {
          ...
          numSlices: 168,
          sliceSrc:
            'https://eeum-brain.com/static/static/eLemur-B1/slice',
          startSlice: 1,
          swiperOption: {
            lazy: true,
            direction: 'horizontal',
        ...
        },
        {
          ...
          numSlices: 168,
          sliceSrc:
            'https://eeum-brain.com/static/static/eLemur-B2/slice',
          startSlice: 1,
          swiperOption: {
            lazy: true,
            direction: 'horizontal',

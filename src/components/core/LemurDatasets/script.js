      ...
      items: [
        {
          ...
          numSlices: 180,
          sliceSrc:
            'http://161.122.102.55/static/static/reference_gallery/reference_wo_dapi/slice',
          startSlice: 128,
          swiperOption: {
            lazy: true,
        ...
        },
        {
          ...
          numSlices: 180,
          sliceSrc:
            'http://161.122.102.55/static/static/reference_gallery/ref2/slice',
          startSlice: 1,
          swiperOption: {
            lazy: true,
            direction: 'horizontal',
